package edu.nwmissouri.authors;
...
public class ProducerAuthors {
  ...
  public static void main(String[] argv) throws Exception {
    ...
    while (!line.equals("exit")) {
      ProducerRecord<String, String> rec = new ProducerRecord<String, String>(topicName, input1.reverse().toString());
      producer.send(rec);
      line = in.nextLine();
    }
